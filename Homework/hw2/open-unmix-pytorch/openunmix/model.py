...
class Separator(nn.Module):
    ...
    def forward(self, audio: Tensor) -> Tensor:
        ...
        for j, (target_name, target_module) in enumerate(self.target_models.items()):
            ...
            spectrograms[..., j] = target_spectrogram  #### (nb_samples, nb_channels, nb_bins, nb_frames)
        ...
        # inverse STFT
        if self.griffinlim:
            print(targets_stft.shape)
            estimates = librosa.griffinlim(targets_stft)
